...
var questions = ["Is Iceland always covered in ice?","What ocean lies east of the US?","What is 3x4?"];
var options = ["1) true 2) false","1) pacific 2) eastern 3) indian 4) atlantic","1) 3 2) 5 3) 9 4) 12"];
var answers = ["1,3,3"];
...
//only work on html elements
if(currentQuestion == 0){
    buttons[2].hide();
    buttons[3].hide();
}

//if current option isn't equal to -1
if(currentOption != -1){
